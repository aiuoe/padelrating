...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.questions.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("admin.questions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('openfield') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="openfield" id="openfield" value="1" {{ old('openfield', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="row answerrow">
               <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('answer1') ? 'is-invalid' : '' }}" type="text" name="answer1" id="answer1" value="{{ old('answer1', '') }}" required>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('score1') ? 'is-invalid' : '' }}" type="number" name="score1" id="score1" value="{{ old('score1', '') }}" step="0.1">
            ...
            <div class="row answerrow">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('answer2') ? 'is-invalid' : '' }}" type="text" name="answer2" id="answer2" value="{{ old('answer2', '') }}" required>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('score2') ? 'is-invalid' : '' }}" type="number" name="score2" id="score2" value="{{ old('score2', '') }}" step="0.1">
            ...
            <div class="row answerrow">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('answer3') ? 'is-invalid' : '' }}" type="text" name="answer3" id="answer3" value="{{ old('answer3', '') }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('score3') ? 'is-invalid' : '' }}" type="number" name="score3" id="score3" value="{{ old('score3', '') }}" step="0.1">
            ...
            <div class="row answerrow">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('answer4') ? 'is-invalid' : '' }}" type="text" name="answer4" id="answer4" value="{{ old('answer4', '') }}">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('score4') ? 'is-invalid' : '' }}" type="number" name="score4" id="score4" value="{{ old('score4', '') }}" step="0.1">
