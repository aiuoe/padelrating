    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clubs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indoor_courts') ? 'is-invalid' : '' }}" type="number" name="indoor_courts" id="indoor_courts" value="{{ old('indoor_courts', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('outdor_courts') ? 'is-invalid' : '' }}" type="number" name="outdor_courts" id="outdor_courts" value="{{ old('outdor_courts', '') }}" step="1">
