    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.scores.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tournament') ? 'is-invalid' : '' }}" name="tournament_id" id="tournament_id">
                    @foreach($tournaments as $id => $tournament)
                        <option value="{{ $id }}" {{ old('tournament_id') == $id ? 'selected' : '' }}>{{ $tournament }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('team_1_player_1') ? 'is-invalid' : '' }}" name="team_1_player_1_id" id="team_1_player_1_id" required>
                    @foreach($team_1_player_1s as $id => $team_1_player_1)
                        <option value="{{ $id }}" {{ old('team_1_player_1_id') == $id ? 'selected' : '' }}>{{ $team_1_player_1 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('set_1_team_1') ? 'is-invalid' : '' }}" type="number" name="set_1_team_1" id="set_1_team_1" value="{{ old('set_1_team_1', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('set_2_team_2') ? 'is-invalid' : '' }}" type="number" name="set_2_team_2" id="set_2_team_2" value="{{ old('set_2_team_2', '') }}" step="1">
