...
class ClubsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('player.clubs.index');
    }
    ...
    public function create()
    {
        ...
        return view('player.clubs.create', compact('users'));
    }
    ...
    public function store(StoreClubRequest $request)
    {
        ...
        return redirect()->route('player.clubs.index');
    }
    ...
    public function edit(Club $club)
    {
        ...
        return view('player.clubs.edit', compact('users', 'club'));
    }
    ...
    public function show(Club $club)
    {
        ...
        return view('player.clubs.show', compact('club'));
    }
