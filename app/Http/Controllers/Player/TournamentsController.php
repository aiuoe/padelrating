...
class TournamentsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('player.tournaments.index');
    }
    ...
    public function create()
    {
        ...
        return view('player.tournaments.create', compact('clubs'));
    }
    ...
    public function edit(Tournament $tournament)
    {
        ...
        return view('player.tournaments.edit', compact('clubs', 'tournament'));
    }
    ...
    public function show(Tournament $tournament)
    {
        ...
        return view('player.tournaments.show', compact('tournament'));
    }
